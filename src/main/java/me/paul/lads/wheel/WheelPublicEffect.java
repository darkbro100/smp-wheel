...
//		spinner.sendMessage(ChatColor.DARK_RED + "You... monster...");
//		Bukkit.broadcastMessage(ChatColor.DARK_RED + spinner.getName() + "has ended SMPLive...");
//		Bukkit.getOnlinePlayers().forEach(player -> {
//			Location loc = player.getLocation();
//			player.getWorld().spawn(loc, EnderDragon.class);
//			player.getWorld().spawn(loc, org.bukkit.entity.Wither.class);
